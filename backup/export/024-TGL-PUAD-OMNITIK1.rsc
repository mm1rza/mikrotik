# jun/22/2023 00:00:01 by RouterOS 6.47.10
# software id = 47HK-2YAS
#
# model = RBSXTsq5nD
# serial number = D3B30C741257
/interface bridge
add name=bridge
/interface wireless
set [ find default-name=wlan1 ] band=5ghz-a/n channel-width=20/40mhz-XX \
    country=no_country_set disabled=no frequency=5825 frequency-mode=\
    superchannel mode=station-bridge radio-name=FUAD scan-list=4980,5725,5875 \
    ssid="Maha suci Allah" station-roaming=enabled
...
/ip address
add address=192.168.55.24/24 interface=bridge network=192.168.55.0
/ip dns
set allow-remote-requests=yes cache-max-ttl=1d servers=10.10.0.1,192.168.55.1
/ip route
...
/system identity
set name=024-TGL-PUAD-OMNITIK1
/system ntp client
