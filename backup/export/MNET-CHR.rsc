# jun/22/2023 12:00:00 by RouterOS 6.48.6
...
add comment="5M/5M 7M/7M 3750K/3750K 10/10 1 625K/625K" insert-queue-before=\
    ...
    pool-free
add insert-queue-before=dhcp-WUZZ local-address=10.124.40.1 name=dhcp-WUZZ \
    on-up=":local ips [/ppp active get [find name=\$user] address];\r\
    \n:local up [/ppp active get [find name=\$user] uptime];\r\
    \n:local caller [/ppp active get [find name=\$user] caller-id];\r\
    \n:local service [/ppp active get [find name=\$user] service];\r\
    ...
    "100M/100M 0/0 0/0 0/0 8 3M/3M" remote-address=pool-wuzz
/queue interface
...
set update-time=no
/ip dns
set allow-remote-requests=yes cache-max-ttl=30m cache-size=51200KiB servers=\
    9.9.9.9,1.1.1.1
/ip dns static
...
add address=speedtest.cbn.id disabled=yes list=list-ip-speedtest
...
add address=112.78.177.9 comment=mnet-router-remote list=ip-publik-client
...
add action=reject chain=input comment="                DROP ddos" dst-port=21 \
...
add action=add-src-to-address-list address-list=zz-list-ip-brute-force-FINAL \
    ...
    "                ADD ddos ip publik" protocol=tcp src-address-list=\
    zzz-list-ip-brute-force-tcp-4
add action=add-src-to-address-list address-list=zzz-list-ip-brute-force-tcp-4 \
    address-list-timeout=1m chain=input protocol=tcp src-address-list=\
...
add action=add-src-to-address-list address-list=zzz-list-ip-brute-force-tcp-2 \
    address-list-timeout=1m chain=input protocol=tcp src-address-list=\
    zzz-list-ip-brute-force-tcp-1
add action=add-src-to-address-list address-list=zzz-list-ip-brute-force-tcp-1 \
    address-list-timeout=1d5m chain=input connection-state=new \
    dst-address-list=!list-ip-trusted protocol=tcp src-address-list=\
    !ip-publik-client
add action=add-src-to-address-list address-list=zz-list-ip-brute-force-FINAL \
    address-list-timeout=none-dynamic chain=input protocol=udp \
    src-address-list=zzz-list-ip-brute-force-udp-4
add action=add-src-to-address-list address-list=zzz-list-ip-brute-force-udp-4 \
    address-list-timeout=1m chain=input protocol=udp src-address-list=\
...
add action=add-src-to-address-list address-list=zzz-list-ip-brute-force-udp-2 \
    address-list-timeout=1m chain=input protocol=udp src-address-list=\
    zzz-list-ip-brute-force-udp-1
add action=add-src-to-address-list address-list=zzz-list-ip-brute-force-udp-1 \
    address-list-timeout=1d5m chain=input connection-state=new \
    dst-address-list=!list-ip-trusted protocol=udp src-address-list=\
    !ip-publik-client
add action=add-src-to-address-list address-list=zz-list-ip-brute-force-FINAL \
    address-list-timeout=none-dynamic chain=input dst-address-list=\
    !list-ip-trusted packet-size=100 protocol=icmp src-address-list=\
    !ip-publik-client
add action=add-src-to-address-list address-list=zz-list-ip-brute-force-FINAL \
    address-list-timeout=none-dynamic chain=input dst-address-list=\
    !list-ip-trusted packet-size=200 protocol=icmp src-address-list=\
    !ip-publik-client
/ip firewall mangle
...
add action=dst-nat chain=dstnat comment="172.16.0.1 ke pc mirza" dst-address=\
    172.16.0.1 to-addresses=10.123.22.4
...
add action=dst-nat chain=dstnat dst-address-list=ip-publik dst-port=3389 \
    protocol=tcp to-addresses=10.123.22.6 to-ports=3389
add action=dst-nat chain=dstnat dst-address-list=ip-publik dst-port=5938 \
    protocol=tcp to-addresses=10.123.22.6 to-ports=5938
add action=dst-nat chain=dstnat dst-address-list=ip-publik dst-port=2112 \
    protocol=tcp to-addresses=10.123.22.6 to-ports=2112
add action=dst-nat chain=dstnat dst-address-list=ip-publik dst-port=3389 \
    protocol=udp to-addresses=10.123.22.6 to-ports=3389
add action=dst-nat chain=dstnat dst-address-list=ip-publik dst-port=5938 \
    protocol=udp to-addresses=10.123.22.6 to-ports=5938
add action=dst-nat chain=dstnat dst-address-list=ip-publik dst-port=2112 \
    protocol=udp to-addresses=10.123.22.6 to-ports=2112
...
add action=dst-nat chain=dstnat comment=kukuh disabled=yes dst-address-list=\
    ip-publik dst-port=44321 protocol=tcp to-addresses=10.123.22.2 to-ports=\
    44321
...
add action=drop chain=prerouting dst-port=443 protocol=udp src-address-list=\
    zz-list-ip-brute-force-FINAL
add action=drop chain=prerouting comment=\
    "                DROP tunneling (PPTP)" dst-port=1723 protocol=tcp \
    src-address-list=zz-list-ip-brute-force-FINAL
add action=drop chain=prerouting dst-port=1723 protocol=udp src-address-list=\
    zz-list-ip-brute-force-FINAL
add action=drop chain=prerouting comment=\
    "                DROP tunneling (L2TP)" dst-port=1701 protocol=tcp \
    src-address-list=zz-list-ip-brute-force-FINAL
add action=drop chain=prerouting dst-port=1701 protocol=udp src-address-list=\
    zz-list-ip-brute-force-FINAL
add action=drop chain=prerouting comment=\
    "                DROP tunneling OVPN" disabled=yes dst-port=1194 \
    protocol=tcp src-address-list=zz-list-ip-brute-force-FINAL
add action=drop chain=prerouting disabled=yes dst-port=1194 protocol=udp \
    src-address-list=zz-list-ip-brute-force-FINAL
add action=drop chain=prerouting comment="                DROP ddos dns" \
...
add action=drop chain=prerouting comment="                DROP ddos" \
    dst-port=21-23 protocol=tcp src-address-list=zz-list-ip-brute-force-FINAL
add action=drop chain=prerouting dst-port=14561-14570 protocol=tcp \
    src-address-list=zz-list-ip-brute-force-FINAL
...
add action=drop chain=prerouting content=users.dat
/ip ipsec policy
