...
# software id = 4PET-TFCA
#
# model = RBLHG-5nD
# serial number = E6B20D2CDE68
/interface bridge
add name=bridge
/interface wireless
set [ find default-name=wlan1 ] band=5ghz-a/n channel-width=20/40mhz-XX \
    ...
    superchannel mode=station-bridge radio-name=SRI scan-list=\
    5175,5805,4980,5725,5875 ssid=Mnet-OB-2-OMNITIK station-roaming=enabled \
    tx-power=6 tx-power-mode=all-rates-fixed
...
/ip address
add address=192.168.55.14/24 interface=bridge network=192.168.55.0
/ip dns
