# jun/22/2023 00:00:00 by RouterOS 6.47.10
# software id = 6HRT-D0I7
#
# model = RBLHG-5nD
# serial number = E6B40D1AACE8
/interface bridge
add name=bridge
/interface wireless
set [ find default-name=wlan1 ] band=5ghz-a/n country=no_country_set \
    disabled=no frequency=5725 frequency-mode=superchannel mode=\
    station-bridge radio-name=DIKROM scan-list=5175,5805,4980,5725,5875 ssid=\
    Mnet-OB-2-OMNITIK station-roaming=enabled
...
/ip address
add address=192.168.55.15/24 interface=bridge network=192.168.55.0
/ip dns
...
/system identity
set name=015-JTB-DIKROM-OMNITIK1
/system ntp client
