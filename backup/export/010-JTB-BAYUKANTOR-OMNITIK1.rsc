# jun/22/2023 12:00:01 by RouterOS 6.47.10
# software id = FIVZ-Q26H
#
# model = RBLHG-5nD
# serial number = D3AB0C266804
/interface bridge
add name=bridge
/interface wireless
set [ find default-name=wlan1 ] band=5ghz-a/n channel-width=20/40mhz-eC \
    country=no_country_set disabled=no frequency=5175 frequency-mode=\
    superchannel mode=station-bridge radio-name="BAYU KANTOR" scan-list=\
    5175,5805,4980,5725 ssid=Mnet-OB-2-OMNITIK
...
/ip address
add address=192.168.55.10/24 interface=bridge network=192.168.55.0
/ip dns
...
/system identity
set name=010-JTB-BAYUKANTOR-OMNITIK1
/system ntp client
