...
# software id = FALJ-QD21
#
# model = RBLHG-5nD
# serial number = D3AB0C19236C
/interface bridge
add name=bridge
/interface wireless
set [ find default-name=wlan1 ] band=5ghz-a/n country=no_country_set \
    disabled=no frequency=4980 frequency-mode=superchannel mode=\
    station-bridge radio-name="BAYU RUMAH" scan-list=5175,5805,4980,5725 \
    ssid=Mnet-OB-2-OMNITIK
...
/ip address
add address=192.168.55.12/24 interface=bridge network=192.168.55.0
/ip dns
...
/system identity
set name=012-JTB-BAYURUMAH-OMNITIK1
/system ntp client
