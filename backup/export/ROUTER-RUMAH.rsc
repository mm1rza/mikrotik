# jun/22/2023 02:28:00 by RouterOS 6.48.6
...
set [ find default-name=ether2 ] mac-address=EA:EA:EA:00:00:00 name=\
    ether2-pusat
set [ find default-name=ether3 ] mac-address=00:15:C0:85:AA:22 name=\
    ether3-isp2
...
add connect-to=103.143.170.11 keepalive-timeout=10 name=zzzzvpn1LAMA \
...
add max-limit=10M/10M name=aty parent="--------ALL TRAFIK--------" target=\
    192.168.99.26/32
add max-limit=12M/22M name=c parent="--------ALL TRAFIK--------" target=\
    10.10.16.0/24
...
add add-arp=yes address-pool=pool disabled=no insert-queue-before=c \
    ...
    -at=1000k/1000k max-limit=10000k/10000k burst-limit=16000k/16000k burst-th\
    reshold=10000k/10000k burst-time=5/5 parent=\"RUMAHAN\" place-before=\"---\
    -----ALL TRAFIK--------\";\r\
    \n} else={\r\
...
/queue simple
add burst-limit=0/6M burst-threshold=0/5M burst-time=0s/7s limit-at=2M/4M \
...
add burst-limit=8M/10M burst-threshold=6M/8M burst-time=7s/7s limit-at=2M/4M \
    max-limit=6M/8M name=c3-rini parent=c target=10.10.16.5/32
add burst-limit=8M/11M burst-threshold=6M/8M burst-time=7s/15s limit-at=2M/4M \
    max-limit=6M/8M name=c4-anis parent=c target=10.10.16.4/32
add burst-limit=9M/11M burst-threshold=7M/9M burst-time=7s/15s limit-at=2M/4M \
    max-limit=7M/9M name=c5-andi parent=c target=10.10.16.6/32
add max-limit=220k/220k name=c99-off parent=c target=10.10.16.0/24
/user group
...
add address=192.168.23.6/24 interface=lan-stb network=192.168.23.0
/ip dhcp-client
...
add address=192.168.99.22 address-lists=ip-lokal-dns-biznet comment=\
    "tv belakang" insert-queue-before=first mac-address=04:95:73:F9:96:D7 \
    rate-limit=25M/25M server=dhcp1
...
add address=192.168.99.31 address-lists=ip-lokal-dns-biznet client-id=\
    1:4:b1:67:99:69:80 comment=abah mac-address=04:B1:67:99:69:80 server=\
    dhcp1
...
add address=192.168.99.32 address-lists=ip-lokal-dns-biznet client-id=\
    1:e6:9:c9:1:40:47 comment=umi mac-address=E6:09:C9:01:40:47 server=dhcp1
add address=192.168.99.45 address-lists=ip-lokal-pc-mirza client-id=\
    1:9e:8a:ff:22:87:5d comment="mirza pc" insert-queue-before=first \
    mac-address=9E:8A:FF:22:87:5D rate-limit=1000M/1000M server=dhcp1
add address=192.168.99.21 address-lists=ip-lokal-dns-biznet client-id=\
    1:dc:9a:7d:93:ab:42 comment="tv tengah" insert-queue-before=first \
    mac-address=DC:9A:7D:93:AB:42 rate-limit=25M/25M server=dhcp1
add address=192.168.99.23 address-lists=ip-lokal-dns-biznet client-id=\
    1:94:90:34:92:8d:59 comment="tv umi" insert-queue-before=first \
    mac-address=94:90:34:92:8D:59 rate-limit=25M/25M server=dhcp1
...
/ip dns
set allow-remote-requests=yes cache-size=51200KiB servers=192.168.23.1
...
/ip firewall filter
add action=fasttrack-connection chain=forward dst-address-list=ip-lokal-mirza
add action=fasttrack-connection chain=forward dst-address-list=ip-lokal-mirza \
    port=80,443,1723,1701,1194 protocol=tcp
add action=fasttrack-connection chain=forward dst-address-list=ip-lokal-mirza \
    port=80,443,1723,1701,1194 protocol=udp
add action=passthrough chain=batas comment="batas suci" disabled=yes
...
add action=passthrough chain=unused-hs-chain comment="COBA DI BAWAH" \
    disabled=yes
add action=accept chain=input disabled=yes src-address-list=ip-lokal-mirza
...
add action=mark-routing chain=prerouting comment=isp3 dst-address-list=\
    ...
    10.10.16.0/24
add action=passthrough chain=vps disabled=yes
add action=mark-routing chain=prerouting comment=vps disabled=yes \
    dst-address=103.143.170.11 new-routing-mark=isp3 passthrough=no \
    src-address-list=ip-lokal-mirza
...
add action=dst-nat chain=dstnat comment=isp1 dst-port=53,5353,853 protocol=\
    udp src-address-list=ip-lokal-dns-biznet to-addresses=192.168.18.1 \
    to-ports=53
add action=dst-nat chain=dstnat comment=isp1 dst-port=53,5353,853 protocol=\
    tcp src-address-list=ip-lokal-dns-biznet to-addresses=192.168.18.1 \
    to-ports=53
add action=dst-nat chain=dstnat comment="PC MIRZA > DNS" disabled=yes \
    dst-port=53,5353,853 protocol=udp src-address-list=ip-lokal-pc-mirza \
    to-addresses=192.168.18.1 to-ports=53
add action=dst-nat chain=dstnat comment="PC MIRZA > DNS" disabled=yes \
    dst-port=53,5353,853 protocol=tcp src-address-list=ip-lokal-pc-mirza \
    to-addresses=192.168.18.1 to-ports=53
add action=dst-nat chain=dstnat comment=vpn1 dst-port=53,5353,853 protocol=\
    udp src-address-list=ip-lokal to-addresses=10.123.22.3 to-ports=53
add action=dst-nat chain=dstnat comment=vpn1 dst-port=53,5353,853 protocol=\
    tcp src-address-list=ip-lokal to-addresses=10.123.22.3 to-ports=53
add action=dst-nat chain=dstnat comment=vpn2 dst-port=53,5353,853 protocol=\
    udp src-address-list=ip-lokal to-addresses=10.123.22.5 to-ports=53
add action=dst-nat chain=dstnat comment=vpn2 dst-port=53,5353,853 protocol=\
    tcp src-address-list=ip-lokal to-addresses=10.123.22.5 to-ports=53
add action=dst-nat chain=dstnat comment=isp3 dst-port=53,5353,853 protocol=\
    udp src-address-list=ip-lokal to-addresses=192.168.23.1 to-ports=53
add action=dst-nat chain=dstnat comment=isp3 dst-port=53,5353,853 protocol=\
    tcp src-address-list=ip-lokal to-addresses=192.168.23.1 to-ports=53
add action=dst-nat chain=dstnat comment=isp1 dst-port=53,5353,853 protocol=\
    udp src-address-list=ip-lokal to-addresses=192.168.18.1 to-ports=53
add action=dst-nat chain=dstnat comment=isp1 dst-port=53,5353,853 protocol=\
    tcp src-address-list=ip-lokal to-addresses=192.168.18.1 to-ports=53
add action=dst-nat chain=dstnat comment=isp2 dst-port=53,5353,853 protocol=\
    udp src-address-list=ip-lokal to-addresses=10.20.254.1 to-ports=53
add action=dst-nat chain=dstnat comment=isp2 dst-port=53,5353,853 protocol=\
    tcp src-address-list=ip-lokal to-addresses=10.20.254.1 to-ports=53
...
add action=dst-nat chain=dstnat comment=mirzapc1 protocol=tcp \
    src-address-list=ip-lokal-vpn to-addresses=192.168.99.45
...
add comment="cek isp1" distance=1 dst-address=1.1.1.3/32 gateway=192.168.18.1
...
add comment=isp1 distance=44 dst-address=103.143.170.11/32 gateway=\
    192.168.18.1
/ip route rule
add comment="PC MIRZA PAKSA" disabled=yes src-address=192.168.99.36/32 table=\
    isp3
add comment="HP IP" disabled=yes src-address=192.168.99.2/32 table=isp3
add comment="TV TENGAH" disabled=yes src-address=192.168.99.27/32 table=isp3
...
add dst-address=192.168.23.0/24 table=isp2
/ip service
...
add name=rini@mnet.com password=rini@mnet.com profile=MNET-2 remote-address=\
    10.10.16.5 service=pppoe
add name=agus@mnet.com password=agus@mnet.com profile=MNET-2 remote-address=\
    10.10.16.3 service=pppoe
...
add dont-require-permissions=no name="!  isp1    ON ( AKTIF )" owner=mm1rza \
    ...
    source="/tool netwatch set disabled=no [find comment=\"   isp1 biz google\
    \"]\r\
    \n/tool netwatch set disabled=yes [find comment=\"z - isp1 biz google\"]\r\
    \n\r\
...
add dont-require-permissions=no name="!  isp1   OFF" owner=mm1rza policy=\
    ftp,reboot,read,write,policy,test,password,sniff,sensitive,romon source="/\
    tool netwatch set disabled=yes [find comment=\"   isp1 biz google\"]\r\
    \n/tool netwatch set disabled=yes [find comment=\"   isp1 biz quad one\"]\
    \r\
    \n/tool netwatch set disabled=no [find comment=\"z - isp1 biz google\"]\r\
    \n\r\
...
set enabled=no
/tool netwatch
add comment="   isp2 mnet" down-script="\r\
...
add comment="   isp3" down-script="/ip route disable [find comment=\"isp3\"]\r\
    ...
    \n\r\
    \n/interface enable vpn1\r\
    \n/interface enable vpn2" host=1.1.1.2 interval=5s up-script="/ip route en\
    able [find comment=\"isp3\"]\r\
...
add comment="201 ap ats r tamu" down-script="/tool fetch url=\"https://api.tel\
    ...
    =no;" host=192.168.99.201 interval=5s up-script="/tool fetch url=\"https:/\
    /api.telegram.org/bot1353625910:AAGAPgQZzOh1JL2vN8jWriJs6XR-xInew04/sendme\
    ssage\\\?chat_id=-1001184386305&text=\\E2\\9C\\85 201 ap ats r tamu\" keep\
    -result=no;"
...
add comment="202 ap dpn kmr 5gh" disabled=yes down-script="/tool fetch url=\"h\
    ttps://api.telegram.org/bot1353625910:AAGAPgQZzOh1JL2vN8jWriJs6XR-xInew04/\
    sendmessage\\\?chat_id=-1001184386305&text=\\E2\\9D\\8C 202  ap dpn kmr 5g\
    h\" keep-result=no;" host=192.168.99.202 interval=5s up-script="/tool fetc\
    h url=\"https://api.telegram.org/bot1353625910:AAGAPgQZzOh1JL2vN8jWriJs6XR\
    -xInew04/sendmessage\\\?chat_id=-1001184386305&text=\\E2\\9C\\85 202  ap d\
    pn kmr 5gh\" keep-result=no;"
add comment="203 ap zte tv" down-script="/tool fetch url=\"https://api.telegra\
    ...
    t_id=-1001184386305&text=\\E2\\9D\\8C 203 ap zte tv\" keep-result=no;" \
    host=192.168.99.203 interval=5s up-script="/tool fetch url=\"https://api.t\
    elegram.org/bot1353625910:AAGAPgQZzOh1JL2vN8jWriJs6XR-xInew04/sendmessage\
    \\\?chat_id=-1001184386305&text=\\E2\\9C\\85 203 ap zte tv\" keep-result=n\
    o;"
add comment="204 ap dpn kmr dpn mrza" down-script="/tool fetch url=\"https://a\
    ...
    keep-result=no;" host=192.168.99.204 interval=5s up-script="/tool fetch ur\
    l=\"https://api.telegram.org/bot1353625910:AAGAPgQZzOh1JL2vN8jWriJs6XR-xIn\
    ew04/sendmessage\\\?chat_id=-1001184386305&text=\\E2\\9C\\85 204 ap dpn km\
    r dpn mrza\" keep-result=no;"
add comment="253 ap outdoor lawas" down-script="/tool fetch url=\"https://api.\
    telegram.org/bot1353625910:AAGAPgQZzOh1JL2vN8jWriJs6XR-xInew04/sendmessage\
    \\\?chat_id=-1001184386305&text=\\E2\\9D\\8C 253 ap outdoor lawas\" keep-r\
    esult=no;" host=192.168.99.253 interval=5s up-script="/tool fetch url=\"ht\
    tps://api.telegram.org/bot1353625910:AAGAPgQZzOh1JL2vN8jWriJs6XR-xInew04/s\
    endmessage\\\?chat_id=-1001184386305&text=\\E2\\9C\\85 253 ap outdoor lawa\
    s\" keep-result=no;"
add comment="   isp1 biz google" down-script="/ip route disable [find comment=\
    \"isp1\"]\r\
    \n/ip firewall mangle disable [find comment=\"isp1\"]\r\
    \n/ip firewall nat disable [find comment=\"isp1\"]\r\
    \n\r\
    ...
    \n/tool fetch url=\"https://api.telegram.org/bot1353625910:AAGAPgQZzOh1JL2\
    vN8jWriJs6XR-xInew04/sendmessage\\\?chat_id=-1001184386305&text=\\E2\\9D\\\
    8C isp1 rumah\" keep-result=no;" host=8.8.4.4 interval=5s up-script="/ip r\
    oute enable [find comment=\"isp1\"]\r\
    \n/ip firewall mangle enable [find comment=\"isp1\"]\r\
    \n/ip firewall nat enable [find comment=\"isp1\"]\r\
    \n\r\
    \n/ip route enable [find comment=\"iisp1\"]\r\
...
add comment="z - isp1 biz google" disabled=yes down-script="\r\
    \nlog error (\"isp1 rumah\")\r\
    \n/tool fetch url=\"https://api.telegram.org/bot1353625910:AAGAPgQZzOh1JL2\
    vN8jWriJs6XR-xInew04/sendmessage\\\?chat_id=-1001184386305&text=\\E2\\9D\\\
    8C isp1 rumah notif\" keep-result=no;" host=8.8.4.4 interval=3s timeout=\
    100ms up-script="\r\
    \nlog warning (\"isp1 rumah\")\r\
    \n/tool fetch url=\"https://api.telegram.org/bot1353625910:AAGAPgQZzOh1JL2\
    vN8jWriJs6XR-xInew04/sendmessage\\\?chat_id=-1001184386305&text=\\E2\\9C\\\
    85 isp1 rumah notif\" keep-result=no;"
/tool romon
