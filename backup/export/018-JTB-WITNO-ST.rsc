# jun/21/2023 12:00:00 by RouterOS 6.47.10
# software id = SYQU-HW1J
#
# model = RBLHG-5nD
# serial number = D3AB0CDEBF8A
/interface bridge
add name=bridge
/interface wireless
set [ find default-name=wlan1 ] band=5ghz-a/n channel-width=20/40mhz-XX \
    country=no_country_set disabled=no frequency=5810 frequency-mode=\
    superchannel mode=station-bridge radio-name=Mnet scan-list=\
    4980,5200,5015,5780 ssid=Mnet-OB-3-WITNO station-roaming=enabled
...
/ip address
add address=192.168.55.18/24 interface=bridge network=192.168.55.0
/ip dns
