# feb/18/2023 12:00:00 by RouterOS 6.48.6
# software id = N5FN-23MN
#
# model = RBLHG-5nD
# serial number = E6B20D152045
/interface bridge
add name=bridge
/interface wireless
set [ find default-name=wlan1 ] band=5ghz-a/n country=no_country_set \
    default-authentication=no disabled=no frequency=5050 frequency-mode=\
    superchannel mode=bridge radio-name=Mnet scan-list=4980,5725,5875 ssid=\
    Mnet-OB-4-PAGER station-roaming=enabled wireless-protocol=nstreme
...
add interface=wlan1 mac-address=48:8F:5A:BC:12:8F vlan-mode=no-tag
/ip address
add address=192.168.55.21/24 interface=bridge network=192.168.55.0
/ip dns
...
/system identity
set name=021-JTB-SD-PAGER-3-PTP
/system ntp client
