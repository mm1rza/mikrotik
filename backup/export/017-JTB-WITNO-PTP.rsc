# jun/22/2023 00:00:00 by RouterOS 6.45.9
# software id = VN92-HGMA
#
# model = RBLHG-5nD
# serial number = D3AB0C69F84B
/interface bridge
add comment="40 eC" name=bridge
/interface wireless
set [ find default-name=wlan1 ] band=5ghz-a/n country=no_country_set \
    default-authentication=no disabled=no frequency=5200 frequency-mode=\
    superchannel hide-ssid=yes installation=any mode=bridge preamble-mode=\
    long radio-name=Mnet scan-list=4920-5900 ssid=Mnet-OB-3-WITNO \
...
add interface=wlan1 mac-address=48:8F:5A:B9:CB:C9 vlan-mode=no-tag
add interface=wlan1 mac-address=48:8F:5A:B9:CB:C9 vlan-mode=no-tag
/ip address
add address=192.168.55.17/24 interface=bridge network=192.168.55.0
/ip dns
