# jun/21/2023 00:00:00 by RouterOS 6.47.10
# software id = F371-ZY5D
#
# model = RBLHG-5nD
# serial number = D3AB0C9C9C52
/interface bridge
add name=bridge
/interface wireless
set [ find default-name=wlan1 ] antenna-gain=0 band=5ghz-a/n channel-width=\
    20/40mhz-XX country=no_country_set disabled=no frequency=5805 \
    frequency-mode=superchannel installation=any mode=station-bridge \
    radio-name=Mnet scan-list=5805,4980 ssid=Mnet-OB-1-AMIN station-roaming=\
    enabled tx-power=24 tx-power-mode=all-rates-fixed
...
/ip address
add address=192.168.55.5/24 interface=bridge network=192.168.55.0
/ip dns
