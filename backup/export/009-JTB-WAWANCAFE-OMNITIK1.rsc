...
# software id = 4XP0-X2ZC
#
# model = RBLHG-5nD
# serial number = D3AB0CC068F7
/interface bridge
add name=bridge
/interface wireless
set [ find default-name=wlan1 ] band=5ghz-a/n channel-width=20/40mhz-eC \
    ...
    superchannel mode=station-bridge radio-name="WAWAN CAFE" scan-list=\
...
/ip address
add address=192.168.55.9/24 interface=bridge network=192.168.55.0
/ip dns
...
/system identity
set name=009-JTB-WAWANCAFE-OMNITIK1
/system ntp client
