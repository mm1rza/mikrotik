...
#
# model = RBLHG-5nD
# serial number = D3AB0CBC453F
/interface bridge
add name=bridge
/interface wireless
set [ find default-name=wlan1 ] antenna-gain=0 band=5ghz-a/n country=\
    no_country_set disabled=no frequency=5175 frequency-mode=superchannel \
    installation=any mode=station-bridge radio-name=OZI scan-list=\
...
/ip address
add address=192.168.55.8/24 interface=bridge network=192.168.55.0
/ip dns
