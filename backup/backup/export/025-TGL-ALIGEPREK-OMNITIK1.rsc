...
set [ find default-name=wlan1 ] band=5ghz-a/n channel-width=20/40mhz-XX \
    ...
    superchannel mode=station-bridge radio-name=ALIGEPREK scan-list=\
    4980,5725,5875 ssid="Maha suci Allah" station-roaming=enabled
...
/ip address
add address=192.168.55.25/24 interface=bridge network=192.168.55.0
/ip dns
...
/system identity
set name=025-TGL-ALIGEPREK-OMNITIK1
/system ntp client
