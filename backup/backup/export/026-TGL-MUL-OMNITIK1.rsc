...
# software id = GIIM-0YJW
#
# model = RBLHG-5nD
# serial number = D3AB0C32CB1D
/interface bridge
add name=bridge
/interface wireless
set [ find default-name=wlan1 ] band=5ghz-a/n channel-width=20/40mhz-XX \
    ...
    superchannel mode=station-bridge radio-name=MUL scan-list=4980,5725,5875 \
...
/ip address
add address=192.168.55.26/24 interface=bridge network=192.168.55.0
/ip dns
