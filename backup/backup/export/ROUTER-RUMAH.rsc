# sep/02/2023 02:28:01 by RouterOS 6.49.8
...
add name=lan-rumah
/interface wireless
set [ find default-name=wlan1 ] band=2ghz-g/n country=indonesia disabled=no \
    frequency=2457 mac-address=7A:78:EE:CA:52:90 mode=ap-bridge radio-name=\
    tplink ssid=KAROKE tx-power=4 tx-power-mode=all-rates-fixed
/interface ethernet
set [ find default-name=ether1 ] mac-address=94:90:34:B6:84:11 name=\
    ether1-isp1
set [ find default-name=ether2 ] name=ether2-pusat
...
add connect-to=103.143.170.11 disabled=no ipsec-secret=vpn.mnet.my.id \
    keepalive-timeout=20 name=vpn1 password=mirzarumah45 profile=default \
...
add max-limit=1G/1G name="--------VIP & LOKAL-------" packet-marks=vip,lokal \
    priority=1/1 target=192.168.99.0/24
add max-limit=10M/10M name=aty target=192.168.99.26/32
add max-limit=1G/1G name="--------ALL TRAFIK--------" target=192.168.99.0/24
/ip dhcp-server
add add-arp=yes address-pool=pool disabled=no insert-queue-before=aty \
...
/queue simple
add max-limit=70M/70M name=RUMAHAN parent="--------ALL TRAFIK--------" \
...
add bridge=lan-rumah interface=ether5
...
set discover-interface-list=RUMAH
...
add disabled=yes interface=vlan-1-rumah-641 list=LAN
add interface=wlan1 list=LAN
add disabled=yes interface=vlan-1-rumah-641 list=RUMAH
add interface=lan-rumah list=RUMAH
...
add address=192.168.18.19/24 interface=ether1-isp1 network=192.168.18.0
...
add address=192.168.99.22 comment="tv belakang" insert-queue-before=first \
    mac-address=04:95:73:F9:96:D7 rate-limit=35M/35M server=dhcp1
...
add address=192.168.99.2 address-lists=ip-lokal-mirza client-id=\
    ...
    server=dhcp1
add address=192.168.99.9 client-id=1:80:35:c1:30:ce:80 comment="ayu xiaomi" \
    mac-address=80:35:C1:30:CE:80 server=dhcp1
...
add address=192.168.99.23 client-id=1:94:90:34:92:8d:59 comment="tv umi" \
    ...
    35M/35M server=dhcp1
add address=192.168.99.24 client-id=1:0:15:c0:85:14:ff comment="tv kamar" \
    insert-queue-before=first mac-address=00:15:C0:85:14:FF rate-limit=\
    35M/35M server=dhcp1
...
add address=192.168.99.2-192.168.99.20 disabled=yes list=ip-lokal-mirza
...
/ip firewall mangle
add action=mark-routing chain=prerouting dst-port=8080 new-routing-mark=isp2 \
    passthrough=no protocol=tcp src-address=192.168.99.21-192.168.99.254
...
add comment=iisp2 distance=2 gateway=10.20.254.1
...
add comment="cek isp1" distance=1 dst-address=94.140.14.14/32 gateway=\
    192.168.18.1
add comment=isp1 distance=4 dst-address=103.143.170.11/32 gateway=\
    192.168.18.1
add comment=isp2 distance=5 dst-address=103.143.170.11/32 gateway=10.20.254.1
add comment="cek isp1" distance=1 dst-address=142.251.241.4/32 gateway=\
    192.168.18.1
/ip route rule
add dst-address=10.0.0.0/12 table=isp2
...
set enabled=no
/tool mac-server
set allowed-interface-list=RUMAH
...
add comment="  VPN1 DNS" down-script="/ip route disable [find comment=\"vpn1\"\
    ...
    \n\r\
    \n/ip dns set servers=10.123.22.3\r\
    \n/ip dns cache flush\r\
    \n:delay 500ms;\r\
    \n\r\
    \n\r\
...
add comment="   isp1" down-script="/ip route disable [find comment=\"isp1\"]\r\
    ...
    \n/tool fetch url=\"https://api.telegram.org/bot1353625910:AAGAPgQZzOh1JL2\
    vN8jWriJs6XR-xInew04/sendmessage\\\?chat_id=-1001184386305&text=\\E2\\9D\\\
    8C isp1 rumah\" keep-result=no;" host=142.251.241.4 interval=12s timeout=\
    2s up-script="/ip route enable [find comment=\"isp1\"]\r\
    \n/ip firewall mangle enable [find comment=\"isp1\"]\r\
    \n/ip firewall nat enable [find comment=\"isp1\"]\r\
    \n\r\
    \n/ip route enable [find comment=\"iisp1\"]\r\
...
add comment="z - isp1" disabled=yes down-script="\r\
    ...
    \n/tool fetch url=\"https://api.telegram.org/bot1353625910:AAGAPgQZzOh1JL2\
    vN8jWriJs6XR-xInew04/sendmessage\\\?chat_id=-1001184386305&text=\\E2\\9D\\\
    8C isp1 94 140 14 14 rumah notif\" keep-result=no;" host=94.140.14.14 \
    interval=3s timeout=100ms up-script="\r\
    \nlog warning (\"isp1 rumah\")\r\
    \n/tool fetch url=\"https://api.telegram.org/bot1353625910:AAGAPgQZzOh1JL2\
    vN8jWriJs6XR-xInew04/sendmessage\\\?chat_id=-1001184386305&text=\\E2\\9C\\\
    85 isp1 94 140 14 14 rumah notif\" keep-result=no;"
add comment="z - isp1" disabled=yes down-script="\r\
    \nlog error (\"isp1 rumah\")\r\
    \n/tool fetch url=\"https://api.telegram.org/bot1353625910:AAGAPgQZzOh1JL2\
    vN8jWriJs6XR-xInew04/sendmessage\\\?chat_id=-1001184386305&text=\\E2\\9D\\\
...
add comment="z - isp1" disabled=yes down-script="\r\
    ...
    \n/tool fetch url=\"https://api.telegram.org/bot1353625910:AAGAPgQZzOh1JL2\
    vN8jWriJs6XR-xInew04/sendmessage\\\?chat_id=-1001184386305&text=\\E2\\9D\\\
    8C isp1 142 251 241 4 rumah notif\" keep-result=no;" host=142.251.241.4 \
    interval=3s timeout=100ms up-script="\r\
    \nlog warning (\"isp1 rumah\")\r\
    \n/tool fetch url=\"https://api.telegram.org/bot1353625910:AAGAPgQZzOh1JL2\
    vN8jWriJs6XR-xInew04/sendmessage\\\?chat_id=-1001184386305&text=\\E2\\9C\\\
    85 isp1 142 251 241 4 rumah notif\" keep-result=no;"
/tool romon
