# aug/20/2023 12:00:00 by RouterOS 6.48.6
# software id = MGKL-S9PF
#
# model = RBLHG-5nD
# serial number = D3AB0CE5886E
/interface bridge
add name=bridge
/interface wireless
set [ find default-name=wlan1 ] band=5ghz-a/n channel-width=20/40mhz-eC \
    ...
    superchannel mode=station-bridge radio-name=SD-PAGER-3 scan-list=\
...
/ip address
add address=192.168.55.22/24 interface=bridge network=192.168.55.0
/ip dns
...
/system identity
set name=022-JTB-SD-PAGER-3-ST
/system ntp client
