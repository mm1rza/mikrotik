# aug/31/2023 12:00:00 by RouterOS 6.47.10
# software id = FU3T-S90L
#
# model = RBLHG-5nD
# serial number = D3AB0C2141A8
/interface bridge
add name=bridge
/interface wireless
set [ find default-name=wlan1 ] band=5ghz-a/n channel-width=20/40mhz-eC \
    country=no_country_set disabled=no frequency=4980 frequency-mode=\
    superchannel mode=station-bridge radio-name="SD SURO 1" scan-list=\
    5175,5805,4980,5725 ssid=Mnet-OB-2-OMNITIK station-roaming=enabled
...
/ip address
add address=192.168.55.11/24 interface=bridge network=192.168.55.0
/ip dns
