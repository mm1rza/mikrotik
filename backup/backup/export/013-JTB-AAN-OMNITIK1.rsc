...
set [ find default-name=wlan1 ] band=5ghz-a/n country=no_country_set \
    ...
    station-bridge radio-name=AAN scan-list=5175,5805,4980,5725 ssid=\
...
/ip address
add address=192.168.55.13/24 interface=bridge network=192.168.55.0
/ip dns
