# feb/18/2023 12:00:00 by RouterOS 6.47.10
# software id = WKDG-27C0
#
# model = RBLHG-5nD
# serial number = E9F00E5E0D13
/interface bridge
add name=bridge1
/interface wireless
set [ find default-name=wlan1 ] band=5ghz-a/n channel-width=20/40mhz-eC \
    country=no_country_set disabled=no frequency=5725 frequency-mode=\
    superchannel mode=station-bridge radio-name="ANJAS VUOCHER" scan-list=\
    5725 ssid=Mnet-OB-2-OMNITIK tx-power-mode=all-rates-fixed
/interface wireless nstreme
set wlan1 enable-nstreme=yes
/interface vlan
add disabled=yes interface=wlan1 name=vlan1 vlan-id=456
...
/ip address
add address=192.168.55.36/24 interface=bridge1 network=192.168.55.0
/ip dns
...
/system identity
set name=036-JTB-SUBEKI-OMNITIK1
/system ntp client
