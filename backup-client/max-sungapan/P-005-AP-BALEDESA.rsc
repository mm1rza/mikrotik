# jun/21/2023 12:00:00 by RouterOS 6.48.6
# software id = AGQN-S0QD
#
# model = RBLHG-5nD
# serial number = E9F00E2CCD6B
/interface bridge
add name=bridge1
/interface wireless
set [ find default-name=wlan1 ] band=5ghz-a/n channel-width=20/40mhz-eC \
    country=no_country_set disabled=no frequency-mode=superchannel mode=\
    bridge scan-list=5250,5500 ssid=GOTOHALE wireless-protocol=nstreme
/interface wireless nstreme
set wlan1 enable-nstreme=yes framer-limit=3900 framer-policy=best-fit
...
/ip address
add address=192.168.56.5/24 interface=bridge1 network=192.168.56.0
/ip dns
