...
# software id = 3X0R-HSVB
#
# model = RBLHG-5nD
# serial number = E9F00E2888DD
/interface bridge
add name=bridge1
/interface wireless
set [ find default-name=wlan1 ] band=5ghz-a/n channel-width=20/40mhz-XX \
    ...
    station-bridge scan-list=5250,5500 ssid=GOTOHALE
...
/ip address
add address=192.168.56.6/24 interface=bridge1 network=192.168.56.0
/ip dns
